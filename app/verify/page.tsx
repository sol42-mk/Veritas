...
export default function VerifyPage() {
 ...
 <div className="mt-3 rounded-lg border border-white/10 bg-transparent/40 backdrop-blur-xl border border-white/5 border-t-white/20 rounded-2xl p-3">
 ...
 className={`cursor-pointer rounded-lg border-2 border-dashed bg-transparent/40 backdrop-blur-xl border border-white/5 border-t-white/20 rounded-2xl/50 backdrop-blur-md transition-colors ${
 dragOver ? "border-white/10 bg-transparent/40 backdrop-blur-xl border border-white/5 border-t-white/20 rounded-2xl0/10" : "border-white/10 hover:border-white/10 hover:bg-transparent/40 backdrop-blur-xl border border-white/5 border-t-white/20 rounded-2xl"
 } ${file ? "p-5" : "px-6 py-14"}`}
 >
 <input
 ...
 <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-lg bg-transparent/40 backdrop-blur-xl border border-white/5 border-t-white/20 rounded-2xl0/10">
 ...
 className="ml-auto text-sm font-medium text-slate-400 hover:text-slate-800"
 >
 Change
 </button>
 </div>
 ...
 Drop a watermarked video here or <span className="text-white">browse files</span>
 </p>
 ...
 disabled={isWorking}
 className="w-full rounded-lg bg-white text-black font-bold px-4 py-3 text-sm font-medium text-white transition-colors hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
 >
 ...
 className="min-w-0 flex-1 rounded-lg border border-white/10 px-3 py-2 font-mono text-sm text-white outline-none transition-colors focus:border-white/10 focus:ring-2 focus:ring-emerald-500/20 focus:bg-white/5 focus:border-white/60"
 />
 <button
 onClick={handleVerifyManual}
 disabled={isWorking || !manualWatermarkId.trim()}
 className="rounded-lg bg-transparent/40 backdrop-blur-xl border border-white/5 border-t-white/20 rounded-2xl hover:bg-white/5 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-white/20 disabled:cursor-not-allowed disabled:opacity-50"
 >
 Check ID
 </button>
 </div>
 ...
 {status === "not-found" && (
 <div className="space-y-3 rounded-lg border border-white/10 bg-transparent/40 backdrop-blur-xl border border-white/5 border-t-white/20 rounded-2xl px-4 py-3">
 ...
 {attemptedExtraction ? (
 <div className="rounded-lg border border-white/10 bg-transparent/40 backdrop-blur-xl border border-white/5 border-t-white/20 rounded-2xl/50 backdrop-blur-md p-3 text-xs text-slate-300">
 <p className="font-medium text-white">Watermark extraction attempt</p>
 ...
 <div className="rounded-lg border border-white/10 bg-transparent/40 backdrop-blur-xl border border-white/5 border-t-white/20 rounded-2xl/50 backdrop-blur-md p-3 text-xs text-slate-300">
 <p className="font-medium text-white">Fingerprint check</p>
 ...
 <section className="space-y-4 rounded-lg border border-white/10 bg-transparent/40 backdrop-blur-xl border border-white/5 border-t-white/20 rounded-2xl p-5">
 ...
 <span className="text-sm font-medium text-white">Verified Veritas record</span>
 </div>

 <div className="grid gap-3 md:grid-cols-2">
 <div className="rounded-lg border border-white/10 bg-transparent/40 backdrop-blur-xl border border-white/5 border-t-white/20 rounded-2xl/50 backdrop-blur-md p-4">
 <p className="text-xs font-medium uppercase tracking-wide text-slate-400">Source</p>
 <p className="mt-2 text-lg font-semibold text-white">{result.record.sourceName}</p>
 <p className="mt-1 font-mono text-xs text-slate-400">source_id: {result.record.sourceId}</p>
 </div>
 ...
 className="break-all text-white hover:text-blue-800"
 >
 {value}
 </a>
 ) : (
 ...
 <span className="break-all font-mono text-white">{result.contextRecord.contextHash}</span>
 </div>
 ...
 target="_blank"
 rel="noopener noreferrer"
 className="break-all font-mono text-white hover:text-blue-800"
 >
 {result.contextRecord.contextMemoSignature}
 </a>
 </div>
 ...
 <div key={citation.id} className="rounded-lg bg-transparent p-3 text-xs">
 ...
 <p className="mt-1 break-all font-mono text-slate-400">{citation.citedBy}</p>
 ...
 className="rounded-lg border border-white/10 px-4 py-2 text-sm font-medium text-slate-700 transition-colors hover:bg-transparent"
 >
 Connect wallet to cite
 </button>
 ) : (
 <div className="rounded-lg bg-transparent p-3 text-xs text-slate-300">
 ...
 className="resize-none rounded-lg border border-white/10 px-3 py-2 text-sm text-white outline-none transition-colors focus:border-white/10 focus:ring-2 focus:ring-emerald-500/20 focus:bg-white/5 focus:border-white/60"
 />
 <button
 onClick={handleSubmitCitation}
 disabled={!citationWallet || citationSourceProfile?.trust.tier !== 1}
 className="rounded-lg bg-white text-black font-bold px-4 py-2 text-sm font-medium text-white transition-colors hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
 >
 Add chain-of-custody citation
 </button>
 {citationMessage && (
 <p className="text-xs text-slate-400">{citationMessage}</p>
 )}
 </div>
 </div>
 )}
 ...
 <div key={flag.id} className="rounded-lg bg-transparent p-3 text-xs">
 <div className="flex flex-wrap gap-2 text-slate-400">
 ...
 className="rounded-lg border border-white/10 px-3 py-2 text-sm text-white outline-none transition-colors focus:border-white/10 focus:ring-2 focus:ring-emerald-500/20 focus:bg-white/5 focus:border-white/60"
 >
 ...
 {flagMessage && (
 <p className="text-xs text-slate-400">{flagMessage}</p>
 )}
 </div>
 </div>
 )}

 <div className="space-y-2 rounded-lg border border-white/10 bg-transparent/40 backdrop-blur-xl border border-white/5 border-t-white/20 rounded-2xl/50 backdrop-blur-md p-3 text-xs">
 {([
